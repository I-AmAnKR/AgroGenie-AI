...
export const mockCropRecommendations = [
  {
    ...
    marketObservation: 'Lasalgaon — one of Asia\'s largest onion markets — is nearby. Current modal prices suggest reasonable returns.',
    npkSuggestion: 'N: 100 kg/ha, P: 60 kg/ha, K: 80 kg/ha',
    duration: '90–110 days',
    rotationFit: 'Excellent (follows tomato)',
    evidenceSources: ['ICAR Onion Production Guide 2023', 'NHRDF Nashik Bulletin']
  },
  {
    rank: 2,
    crop: 'Chickpea (Gram)',
    ...
    evidenceSources: ['ICRISAT Chickpea Manual', 'Maharashtra Agriculture Dept. Advisory 2023']
  },
  {
    rank: 3,
    crop: 'Wheat',
    ...
    marketObservation: 'Wheat is supported by government MSP. Local market demand is steady but not exceptional.',
    npkSuggestion: 'N: 120 kg/ha, P: 60 kg/ha, K: 40 kg/ha',
    duration: '110–120 days',
    rotationFit: 'Acceptable',
    evidenceSources: ['ICAR Wheat Production Manual', 'Agri Dept. Nashik Crop Calendar']
  }
]

export const mockSoilTypes = ['Sandy', 'Clay', 'Loamy', 'Sandy Loam', 'Clay Loam', 'Silty', 'Red Soil', 'Black Cotton Soil', 'Alluvial']
export const mockSeasons = ['Kharif (Jun–Sep)', 'Rabi (Oct–Mar)', 'Zaid (Mar–Jun)']
export const mockCrops = ['Onion', 'Tomato', 'Potato', 'Wheat', 'Rice', 'Maize', 'Soybean', 'Cotton', 'Sugarcane', 'Chickpea', 'Groundnut', 'Bajra', 'Sorghum']
export const mockIrrigationTypes = ['Rainfed', 'Canal', 'Drip', 'Sprinkler', 'Borewell', 'Tank']
export const mockObjectives = [
  { value: 'profit', label: 'Higher profit potential' },
  { value: 'low-risk', label: 'Lower risk' },
  { value: 'low-water', label: 'Lower water requirement' },
  { value: 'soil-health', label: 'Soil improvement' },
