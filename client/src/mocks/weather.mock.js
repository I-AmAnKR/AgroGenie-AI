...
export const mockFarmingImpact = [
...
export const mockWeatherAlerts = [
  { id: 'wa1', type: 'warning', title: 'Moderate Rainfall Advisory', message: 'Rainfall of 15–20mm expected between Wednesday and Thursday. Plan field activities accordingly.', validUntil: '2024-11-22', source: 'IMD Regional (Demo)' },
]
